...
const documents = {
    ...
    "\n   fragment ProjectContentBlockSliceRichText on ProjectSlicesContent_block_sliceRichtext {\n    RichText: primary {\n      header_icons\n      header_title\n      content\n      image\n      image_position\n      image_mask {\n        __typename\n        ...ImageMask\n      }\n    }\n   }\n": types.ProjectContentBlockSliceRichTextFragmentDoc,
    "\n  fragment ProjectContentBlockSliceField on ProjectSlicesContent_block_slice {\n    type\n    label\n    variation {\n      __typename\n      ...ProjectContentBlockSlicePrimary\n      ...ProjectContentBlockSliceRichText\n    }\n  }\n": types.ProjectContentBlockSliceFieldFragmentDoc,
