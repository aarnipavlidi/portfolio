  ...
  return (
    <section className="text-neutral-900 py-4">
      <div className="flex flex-col-reverse justify-between md:flex-row">
        ...
        {
          props.image && <div className={heroImageContainer}>
                ...
                <div className="flex flex-col gap-2">
                  {
                    validateHeroTitle && <Typography
                      ...
                      tag="h1"
                      size="xl"
                      className={`${heroFullWidthContentContainer} uppercase bg-neutral-100/25 border-2 border-current 2xl:text-3xl dark:bg-neutral-200/25`}
                    />
                  }
                  {
                    validateHeroSubtitle && <Typography
